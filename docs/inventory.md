...
![Illustrative deployment inventory table](assets/inventory_table.svg){: width="100%" loading="lazy" }
...
![Illustrative deployment availability timeline](assets/figures/deployment_timeline.webp){: width="100%" loading="lazy" }
...
percentage at right summarizes bins with some data.
...
![Illustrative daily availability calendar](assets/figures/availability_calendar.webp){: width="100%" loading="lazy" }
...
!!! note "Illustrative figures"
    The two figures above use deterministic example availability generated by
    `scripts/generate_docs_figures.py`. They explain how to read the plots; they
    are not current ONC deployment records.
