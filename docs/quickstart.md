...
![Illustrative locally generated spectrogram](assets/figures/example_local_spectrogram.webp){: width="100%" loading="lazy" }
...
- **Horizontal lines:** persistent tones
- **Curves:** sounds whose frequency changes over time
- **Short vertical marks:** brief broadband or tonal events

!!! note "Illustrative figure"
    This figure was generated by the package from deterministic synthetic audio.
    It demonstrates the output layout but is not an ONC observation and is not
